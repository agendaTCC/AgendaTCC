...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'noticias_noticia', (
            ...
            ('autor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['usuarios._User'], null=True, blank=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('conteudo', self.gf('django.db.models.fields.TextField')()),
            ('disciplina', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['disciplinas.Disciplina'], null=True, blank=True)),
            ('departamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['departamentos.Departamento'], null=True, blank=True)),
    ...
    models = {
        ...
        u'noticias.noticia': {
            'Meta': {'ordering': "['-criada_em']", 'object_name': 'Noticia'},
            'autor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['usuarios._User']", 'null': 'True', 'blank': 'True'}),
            'conteudo': ('django.db.models.fields.TextField', [], {}),
            'criada_em': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'departamento': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['departamentos.Departamento']", 'null': 'True', 'blank': 'True'}),
            'disciplina': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['disciplinas.Disciplina']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
        u'semestre.semestre': {
