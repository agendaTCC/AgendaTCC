...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Banca.empresa'
        db.delete_column(u'bancas_banca', 'empresa_id')


    def backwards(self, orm):
        # Adding field 'Banca.empresa'
        db.add_column(u'bancas_banca', 'empresa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresa.Empresa'], null=True, blank=True),
                      keep_default=False)
