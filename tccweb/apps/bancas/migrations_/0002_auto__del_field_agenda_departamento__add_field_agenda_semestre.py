...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Agenda.departamento'
        db.delete_column(u'bancas_agenda', 'departamento_id')

        # Adding field 'Agenda.semestre'
        db.add_column(u'bancas_agenda', 'semestre',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='agenda_departamento', to=orm['semestre.Semestre']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Agenda.departamento'
        db.add_column(u'bancas_agenda', 'departamento',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='agenda_departamento', to=orm['departamentos.Departamento']),
                      keep_default=False)

        # Deleting field 'Agenda.semestre'
        db.delete_column(u'bancas_agenda', 'semestre_id')
