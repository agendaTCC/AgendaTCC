...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Banca.departamento'
        db.delete_column(u'bancas_banca', 'departamento_id')

        # Adding field 'Banca.semestre'
        db.add_column(u'bancas_banca', 'semestre',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banca_semestre', null=True, to=orm['semestre.Semestre']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Banca.departamento'
        db.add_column(u'bancas_banca', 'departamento',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='departamento', null=True, to=orm['departamentos.Departamento'], blank=True),
                      keep_default=False)

        # Deleting field 'Banca.semestre'
        db.delete_column(u'bancas_banca', 'semestre_id')
    ...
    models = {
        ...
        u'bancas.agenda': {
            ...
            'semestre': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agenda_departamento'", 'to': u"orm['semestre.Semestre']"})
        },
        ...
        u'bancas.banca': {
            ...
            'semestre': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'banca_semestre'", 'null': 'True', 'to': u"orm['semestre.Semestre']"})
        },
        u'bancas.dia_agenda': {
