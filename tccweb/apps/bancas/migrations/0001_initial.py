...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bancas_banca', (
            ...
            ('semestre', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='banca_semestre', null=True, to=orm['semestre.Semestre'])),
        ...
        db.create_table(u'bancas_agenda', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('semestre', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agenda_departamento', to=orm['semestre.Semestre'])),
