...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EntregaMonografiaRevisada'
        db.create_table(u'monografias_entregamonografiarevisada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('projeto', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='monografia_revisada_projeto', unique=True, null=True, to=orm['projetos.ProjetoDeGraduacao'])),
            ('data', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('monografia', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'monografias', ['EntregaMonografiaRevisada'])

        # Adding model 'EntregaMonografiaOriginal'
        db.create_table(u'monografias_entregamonografiaoriginal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('projeto', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='monografia_original_projeto', unique=True, null=True, to=orm['projetos.ProjetoDeGraduacao'])),
            ('data', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('monografia', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'monografias', ['EntregaMonografiaOriginal'])


    def backwards(self, orm):
        # Deleting model 'EntregaMonografiaRevisada'
        db.delete_table(u'monografias_entregamonografiarevisada')

        # Deleting model 'EntregaMonografiaOriginal'
        db.delete_table(u'monografias_entregamonografiaoriginal')
    ...
    models = {
        ...
        u'monografias.entregamonografiaoriginal': {
            'Meta': {'object_name': 'EntregaMonografiaOriginal'},
            'data': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'monografia': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'projeto': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'monografia_original_projeto'", 'unique': 'True', 'null': 'True', 'to': u"orm['projetos.ProjetoDeGraduacao']"})
        },
        u'monografias.entregamonografiarevisada': {
            'Meta': {'object_name': 'EntregaMonografiaRevisada'},
            'data': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'monografia': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'projeto': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'monografia_revisada_projeto'", 'unique': 'True', 'null': 'True', 'to': u"orm['projetos.ProjetoDeGraduacao']"})
        },
