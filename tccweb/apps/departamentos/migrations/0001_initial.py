...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'departamentos_departamento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('watermark', self.gf('django.db.models.fields.files.FileField')(default='/home/pumba/Django_Projects/tccweb/tccweb/tccweb/media/img/generico.gif', max_length=100)),
            ('cor', self.gf('departamentos.models.ColorField')(max_length=10, blank=True)),
        ))
        db.send_create_signal(u'departamentos', ['Departamento'])

        # Adding M2M table for field docentes_responsaveis on 'Departamento'
        m2m_table_name = db.shorten_name(u'departamentos_departamento_docentes_responsaveis')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('departamento', models.ForeignKey(orm[u'departamentos.departamento'], null=False)),
            ('_user', models.ForeignKey(orm[u'usuarios._user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['departamento_id', '_user_id'])


    def backwards(self, orm):
        # Deleting model 'Departamento'
        db.delete_table(u'departamentos_departamento')

        # Removing M2M table for field docentes_responsaveis on 'Departamento'
        db.delete_table(db.shorten_name(u'departamentos_departamento_docentes_responsaveis'))
