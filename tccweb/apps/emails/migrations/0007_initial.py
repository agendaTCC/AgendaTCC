...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnviaEmail'
        db.create_table(u'emails_enviaemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('departamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['departamentos.Departamento'])),
            ('filtro', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('assunto', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('corpo', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('enviada_em', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'emails', ['EnviaEmail'])
        ...
        db.create_table(u'emails_emailpadrao', (
            ...
            ('corpo', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('criado_em', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EnviaEmail'
        db.delete_table(u'emails_enviaemail')
    ...
    models = {
        ...
        u'emails.emailpadrao': {
            ...
            'criado_em': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
