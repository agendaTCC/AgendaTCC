...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EnviaEmail.filtro'
        db.alter_column(u'emails_enviaemail', 'filtro', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'EnviaEmail.filtro'
        db.alter_column(u'emails_enviaemail', 'filtro', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
