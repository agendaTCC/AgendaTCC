...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'emails_enviaemail', (
            ...
            ('filtro', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
    ...
    models = {
        ...
        u'emails.enviaemail': {
            ...
            'filtro': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'usuarios._user': {
