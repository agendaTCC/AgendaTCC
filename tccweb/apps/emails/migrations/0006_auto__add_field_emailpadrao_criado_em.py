...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailPadrao.criado_em'
        db.add_column(u'emails_emailpadrao', 'criado_em',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailPadrao.criado_em'
        db.delete_column(u'emails_emailpadrao', 'criado_em')
