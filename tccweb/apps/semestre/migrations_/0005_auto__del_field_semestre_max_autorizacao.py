...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Semestre.max_autorizacao'
        db.delete_column(u'semestre_semestre', 'max_autorizacao')


    def backwards(self, orm):
        # Adding field 'Semestre.max_autorizacao'
        db.add_column(u'semestre_semestre', 'max_autorizacao',
