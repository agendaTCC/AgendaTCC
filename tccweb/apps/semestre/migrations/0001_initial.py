...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'semestre_semestre', (
            ...
            ('grupo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['departamentos.Departamento'])),
            ('semestre', self.gf('django.db.models.fields.CharField')(default=1, max_length=1)),
            ('inicio_semestre', self.gf('django.db.models.fields.DateField')()),
            ('fim_semestre', self.gf('django.db.models.fields.DateField')()),
            ('atual', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('inic_inscricao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_inscricao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inic_banca_alunos', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_banca_alunos', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_titulo_areas', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inic_banca_responsavel', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_banca_responsavel', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('inic_banca_convidado', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_banca_convidado', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('autorizacao_mestrando', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('inic_apresentacao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_apresentacao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('max_autorizacao', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'semestre', ['Semestre'])


    def backwards(self, orm):
        # Deleting model 'Semestre'
        db.delete_table(u'semestre_semestre')
