...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AvaliacaoAluno'
        db.create_table(u'projetos_avaliacaoaluno', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('projeto', self.gf('django.db.models.fields.related.OneToOneField')(related_name='avaliacao_projeto', unique=True, to=orm['projetos.ProjetoDeGraduacao'])),
            ('data', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('capacidade_de_aprendizagem', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('qualidade_do_trabalho', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('produtividade', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('responsabilidade', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('assiduidade', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('iniciativa', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('relacionamento_no_trabalho', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('cooperacao', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('conhecimentos_previos', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2, blank=True)),
            ('observacoes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projetos', ['AvaliacaoAluno'])


    def backwards(self, orm):
        # Deleting model 'AvaliacaoAluno'
        db.delete_table(u'projetos_avaliacaoaluno')
    ...
    models = {
        ...
        u'projetos.avaliacaoaluno': {
            'Meta': {'object_name': 'AvaliacaoAluno'},
            'assiduidade': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'capacidade_de_aprendizagem': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'conhecimentos_previos': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'cooperacao': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'data': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iniciativa': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'observacoes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'produtividade': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'projeto': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'avaliacao_projeto'", 'unique': 'True', 'to': u"orm['projetos.ProjetoDeGraduacao']"}),
            'qualidade_do_trabalho': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'relacionamento_no_trabalho': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
            'responsabilidade': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'})
        },
        u'projetos.declaracaodehoras': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projeto': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'declaracao_projeto'", 'unique': 'True', 'to': u"orm['projetos.ProjetoDeGraduacao']"})
        },
