...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjetoDeGraduacao.justificativa'
        db.delete_column(u'projetos_projetodegraduacao', 'justificativa')

        # Deleting field 'ProjetoDeGraduacao.cancelado'
        db.delete_column(u'projetos_projetodegraduacao', 'cancelado')


    def backwards(self, orm):
        # Adding field 'ProjetoDeGraduacao.justificativa'
        db.add_column(u'projetos_projetodegraduacao', 'justificativa',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjetoDeGraduacao.cancelado'
        db.add_column(u'projetos_projetodegraduacao', 'cancelado',
    ...
    models = {
        ...
        u'departamentos.departamento': {
            ...
            'watermark': ('django.db.models.fields.files.FileField', [], {'default': "'/srv/jetty.com.br/tccweb/tccweb/tccweb/media/img/generico.gif'", 'max_length': '100'})
        },
        ...
        u'projetos.projetodegraduacao': {
            ...
            'aluno': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['usuarios._User']", 'null': 'True', 'blank': 'True'}),
            ...
            'disciplina': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['disciplinas.Disciplina']"}),
            'espc': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orientador': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'orientador_proeto'", 'null': 'True', 'to': u"orm['usuarios._User']"}),
            ...
            'supervisor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'supervisor_proeto'", 'null': 'True', 'to': u"orm['usuarios._User']"}),
