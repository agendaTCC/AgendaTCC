...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeclaracaoDeHoras.projeto'
        db.alter_column(u'projetos_declaracaodehoras', 'projeto_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['projetos.ProjetoDeGraduacao']))
        # Adding unique constraint on 'DeclaracaoDeHoras', fields ['projeto']
        db.create_unique(u'projetos_declaracaodehoras', ['projeto_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DeclaracaoDeHoras', fields ['projeto']
        db.delete_unique(u'projetos_declaracaodehoras', ['projeto_id'])


        # Changing field 'DeclaracaoDeHoras.projeto'
        db.alter_column(u'projetos_declaracaodehoras', 'projeto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projetos.ProjetoDeGraduacao']))
